// <copyright file="RmqRabbitMqHelper.cs" company="OpenTelemetry Authors">
...
{
    public static class RmqRabbitMqHelper
    {
        ...
        static RmqRabbitMqHelper()
        {
            ConnectionFactory = new ConnectionFactory()
            {
                ...
                Port = 5672,
                RequestedConnectionTimeout = Convert.ToInt32(TimeSpan.FromMilliseconds(3000).TotalMilliseconds),
            };
        }
